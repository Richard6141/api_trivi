...
def create_app(test_config=None):
    ...
    def get_all_categories():
        ...
        current_categories = pagination(request, categories)
    ...
    def retrieve_all_questions():
        ...
        current_questions = pagination(request, question)
    ...
    # """
    # @app.route("/questions?page=${integer}", methods=["GET"])
    ...
    #             "catégories": current_categories,
    #             # ceci prendra en compte 'currentCategory': 'Histoire' 
        ...
        try:
            ...
            if question is None:
                ...
                return jsonify({
                    'success': True,
                    'deleted': id,
                    'questions': pagination(request, totals_questions),
